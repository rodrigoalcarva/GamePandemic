      ...
      <div id="navDir" class="dropdown">
				...
				if (!isset($_SESSION["username"])) {
					...
					echo "<div id='logFeito'>
						      	...
						      	<a href='logout.php' id='logoutB'> Logout </a>
									</div>
								</div>";
				}
				?>
					...
					<ul class="dropdown-menu">
						<form class="form-group" action="<?=htmlspecialchars(stripslashes(trim("loginRegister.php")));?>" method="post">
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body">
									<form id="registerForm" class="form-group" action="<?=htmlspecialchars(stripslashes(trim("loginRegister.php")));?>" method="post" enctype="multipart/form-data">
		...
		<div id="corpo">
			<div id="connects">
				<div class="allConnects">
					<div class="img">
						<img id="person1" src="images/person1.png">
					</div>
					<div class="personText">
						...
						<div class="sobre">
							<p>O mais noob do grupo, a sua estratégia é igual a um miúdo de 10 anos. Não o querem ter na equipa! Craque da bola mas não do Pandemic</p>
						</div>
					</div>
				</div>
				<div class="allConnects">
					<div class="img">
						<img id="person1" src="images/person3.png">
					</div>
					<div class="personText">
						<div class="nome">
							<p></p>
						...
						<div class="idade">
							<p>Aplicações e Serviços</p>
						</div>
						<div class="numero">
							<p>Web</p>
						</div>
						<div class="sobre">
							<p>Copyright © 2018 FCUL-DI<br> Alexandre Nascimento / Rodrigo Alcarva <br>All Rights Reserved</p>
						</div>
					</div>
				</div>
				<div class="allConnects" >
					<div class="img">
						<img id="person2" src="images/person2.png">
					</div>
					<div class="personText">
						<div class="nome">
						...
						<div class="sobre">
							<p>O melhor jogador. Até agora dos 2 jogos ganhou 100%. Tem o nível de estratégia de Einstein, tentem-no desafiar.</p>
						</div>
					</div>
				</div>
			</div>
